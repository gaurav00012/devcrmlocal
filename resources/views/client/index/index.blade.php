 ...
 <main class="py-5">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="#" onclick='window.open("http://devcrm.local.com/view-invoice/{{$invoiceDetail->invoice_id}}", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=700,left=500,width=800,height=600")'><button class="btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
