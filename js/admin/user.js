...
var app = new Vue({
  ...
  methods: {
    getUserData: function getUserData() {
      ...
      var getUserUrl = $('#urlAdminUserget').val();
      console.log(getUserUrl);
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(getUserUrl).then(function (response) {});
    },
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\{d}CRM\resources\js\admin\user.js */"./resources/js/admin/user.js");
